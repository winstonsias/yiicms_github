...
<p class="jump">
<b id="wait"><?php echo($data['wait']); ?></b> 秒后页面将自动跳转
</p>
<div>
    <a id="href" id="btn-now" href="<?php echo $data['jumpurl']; ?>">立即跳转</a> 
    <button id="btn-stop" type="button" onclick="stop()">停止跳转</button> 
    <a id="href" id="btn-now" href="<?php echo Yii::app()->createUrl('Public/logout'); ?>">重新登录</a> 
</div>
</div>
