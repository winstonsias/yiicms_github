...
<div class="main-title cf">
		<h2>
			配置排序 [ <a href="<?php echo app()->request->urlReferrer?>">返回列表</a> ]
		</h2>
	</div>
	<div class="sort">
		<form action="" method="post">
			...
			<div class="sort_bottom">
				...
				<button class="sort_cancel btn btn-return" type="button" url="<?php echo app()->request->urlReferrer?>">返 回</button>
			</div>
		</form>
	</div>
