...
?>
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/theme/<?php echo C('CODEMIRROR_THEME')?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('<?php echo Yii::app()->params['main_params']['static_url']; ?>/extendstatic/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
	...
	<!-- 表单 -->
	<form id="form" action="<?php echo url('Addons/build')?>" method="post" class="form-horizontal doc-modal-form">
		<div class="form-item">
...
'model'=>'Example',		//要查的表
	...
	<script type="text/javascript" src="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/codemirror.js"></script>
	<script type="text/javascript" src="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/xml.js"></script>
	<script type="text/javascript" src="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/javascript.js"></script>
	<script type="text/javascript" src="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/clike.js"></script>
	<script type="text/javascript" src="<?php echo Yii::app()->params['main_params']['static_url']; ?>/js/codemirror/php.js"></script>

	<script type="text/javascript" src="<?php echo Yii::app()->params['main_params']['static_url']; ?>/extendstatic/thinkbox/jquery.thinkbox.js"></script>
	...
	<script type="text/javascript">
		...
		$('#preview').click(function(){
			var preview_url = '<?php echo url('Addons/preview')?>';
		...
		$('.ajax-post_custom').click(function(){
	        ...
	        var check_url = '<?php echo url('Addons/checkForm')?>';
			$.ajax({
			   type: "POST",
			   url: check_url,
			   dataType: 'json',
