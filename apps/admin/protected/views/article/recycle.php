...
<block name="body">
    ...
    <div class="tools auth-botton">
        <button url="<?php echo url('article/clear')?>" class="btn ajax-get">清 空</button>
        <button url="<?php echo url('article/permit')?>" class="btn ajax-post" target-form="ids">还 原</button>
    </div>
    ...
    <?php foreach ($list as $vo){?>
		<tr>
			...
			<td><a href="<?php echo url('article/permit',array('ids'=>$vo['id']))?>" class="ajax-get">还原</a>
                </td>
		</tr>
		<?php }?>
	</tbody>
