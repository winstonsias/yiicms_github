...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录</title>
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['main_params']['static_url']; ?>/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['main_params']['static_url']; ?>/css/<?php echo $config['COLOR_STYLE']?>.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo Yii::app()->createUrl('public/login'); ?>" method="post" class="login-form">
                    
                        <h3 class="welcome"><i class="login-logo"></i>YiiCms管理平台</h3>
                        <div id="itemBox" class="item-box">
                            ...
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo Yii::app()->createUrl('public/verify'); ?>">
                            </div>
                        </div>
