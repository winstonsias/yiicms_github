...
<div class="main-title cf">
		<h2>
			导航排序 [ <a href="<?php echo url('channel/index',array('pid'=>gp('pid')))?>">返回列表</a> ]
		</h2>
	</div>
	<div class="sort">
...
<!-- 			<div class="sort_top">
			...
			<div class="sort_bottom">
				...
				<button class="sort_cancel btn btn-return" type="button" url="<?php echo url('channel/index',array('pid'=>gp('pid')))?>">返 回</button>
			</div>
		</form>
	</div>
