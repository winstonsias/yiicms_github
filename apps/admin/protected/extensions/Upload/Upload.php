...
class Upload{
    ...
    public function __construct($config = array(), $driver = '', $driverConfig = null){
        ...
        $driverConfig   =   $driverConfig? $driverConfig : ($this->driverConfig? $this->driverConfig :C('UPLOAD_LOCAL_CONFIG'));
    ...
    public function upload($files='') {
        ...
        return empty($info) ? false : findall_to_array($info);
    }
    ...
    private function setDriver($class, $config){
        Yii::import('ext.Upload.Driver.'.$class);
